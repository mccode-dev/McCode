...
*
* Library: share/monitor_nd_noacc-lib.c
*
* %Identification
* Written by: EF
* Date: Aug 28, 2002
...
/* ========================================================================= */
/* Monitor_nd_noaccInit: this routine is used to parse options                    */
/* ========================================================================= */

void Monitor_nd_noaccInit(Monitornd_noaccDefines_type *DEFS,
...
int Monitor_nd_noaccTrace(Monitornd_noaccDefines_type *DEFS, Monitornd_noaccVariables_type *Vars, _class_particle* _particle)
{
  ...
  if ((Vars->Buffer_Counter >= Vars->Buffer_Block) && (Vars->Flag_List >= 2))
  {
    ...
    { /* save current (possibly append) and re-use Buffer */
      ...
      Monitor_nd_noaccSave(DEFS, Vars);
      Vars->Flag_List = 3;
  ...
  return 1;
} /* end Monitor_nd_noaccTrace */

/* ========================================================================= */
/* Monitor_nd_noaccSave: this routine is used to save data files                  */
/* ========================================================================= */

MCDETECTOR Monitor_nd_noaccSave(Monitornd_noaccDefines_type *DEFS, Monitornd_noaccVariables_type *Vars)
  {
    char   *fname;
    long    i,j;
    double *p0m = NULL;
    ...
    return(detector);
  } /* end Monitor_nd_noaccSave */

/* ========================================================================= */
/* Monitor_nd_noaccFinally: this routine is used to free memory                   */
/* ========================================================================= */

void Monitor_nd_noaccFinally(Monitornd_noaccDefines_type *DEFS,
  Monitornd_noaccVariables_type *Vars)
  {
    int i;
  ...
  } /* end Monitor_nd_noaccFinally */

/* ========================================================================= */
/* Monitor_nd_noaccMcDisplay: this routine is used to display component           */
/* ========================================================================= */

void Monitor_nd_noaccMcDisplay(Monitornd_noaccDefines_type *DEFS,
  Monitornd_noaccVariables_type *Vars)
  {
    double radius, h;
    double xmin;
