# The `Test_PowderN_solo` Instrument

*McStas: Test output of PowderN on a spherical monitor / PSD.*
...
|------|------|-------------|---------|
| comp | 1 | 0=PowderN-with-NCMAT, 1=PowderN | 1 |
...
- [Source code](Test_PowderN_solo.instr) for `Test_PowderN_solo.instr`.
