...
| lmin | AA | Minimum wavelength produced from source | 1.6 |
| lmax | AA | Maximum wavelength produced from source | 2.4 |
...
| DM | AA | Mono lattice spacing (should be chosen compatible with file-unput when Mono=6/7 | 3.3539 |
...
| ax | AA or 1/AA | x-coordinate of 1st direct/recip lattice unit cell vector (depends on recip setting) | 0 |
| ay | AA or 1/AA | y-coordinate of 1st direct/recip lattice unit cell vector (depends on recip setting) | 0 |
| az | AA or 1/AA | z-coordinate of 1st direct/recip lattice unit cell vector (depends on recip setting) | 0 |
| bx | AA or 1/AA | x-coordinate of 2nd direct/recip lattice unit cell vector (depends on recip setting) | 0 |
| by | AA or 1/AA | y-coordinate of 2nd direct/recip lattice unit cell vector (depends on recip setting) | 0 |
| bz | AA or 1/AA | z-coordinate of 2nd direct/recip lattice unit cell vector (depends on recip setting) | 0 |
| cx | AA or 1/AA | x-coordinate of 3rd direct/recip lattice unit cell vector (depends on recip setting) | 0 |
| cy | AA or 1/AA | y-coordinate of 3rd direct/recip lattice unit cell vector (depends on recip setting) | 0 |
| cz | AA or 1/AA | x-coordinate of 3rd direct/recip lattice unit cell vector (depends on recip setting) | 0 |
...
| lambda | AA | Target mochromator wavelength | 2.0 |
