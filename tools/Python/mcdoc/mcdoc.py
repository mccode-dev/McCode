...
<P ALIGN=CENTER>
[ <a href="file://%MCCODE_DOCDIR%/mcstas-manual/manual.html">User Manual (html)</a>
| <a href="file://%MCCODE_DOCDIR%/mcstas-manual.pdf">User Manual (PDF)</a>
| <a href="file://%MCCODE_DOCDIR%/mcstas-components/Component_manual.html">Component Manual (html)</a>
| <a href="file://%MCCODE_DOCDIR%/mcstas-components.pdf">Component Manual (PDF)</a> ]
</P>
