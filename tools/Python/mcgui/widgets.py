...
class Ui_dlgStartSim(object):
    ...
    def retranslateUi(self, dlgStartSim):
        ...
        self.gbxGrid.setTitle(_translate(       "dlgStartSim", "Instrument parameters"))
        self.gbxGrid.setToolTip(_translate(     "dlgStartSim", "<html><body>Set single value for fixed parameters <br><i>OR</i> MIN,MAX in <b>Scan steps</b> and <b>Optimize</b> mode <br><i>OR</i> MIN,START,MAX in <b>Optimize</b> mode to set starting value</html></body>"))
        ...
        self.lblOutputDir.setToolTip(_translate("dlgStartSim", "<html><body>Set a new directory name. Default is using model name and time-stamp</body></html>"))
        ...
        self.lblFormat.setToolTip(_translate(   "dlgStartSim", "<html><body><b>McCode</b>: text based (recommended);<br><b>NeXus</b>: binary HDF5 format</body></html>"))
        self.lblMcdisplays.setText(_translate(  "dlgStartSim", "McDisplay"))
        self.lblMcdisplays.setToolTip(_translate("dlgStartSim", "Show geometry with selected plotter"))
        self.gbxAdvanced.setTitle(_translate(   "dlgStartSim", "Advanced"))
        self.lblRandomSeed.setText(_translate(  "dlgStartSim", "Random seed:"))
        self.lblRandomSeed.setToolTip(_translate("dlgStartSim","Specify a number for reproducible results"))
