...
function( detect_platform_variables resultvarname )
  ...
  if ( BUILD_MCSTAS )
    ...
    set( KDSOURCEFLAGS "CMD(kdsource-config --show buildflags)" )
    ...
    if ( WINDOWS AND MCCODE_BUILD_WINDOWS_MINGW )
      ...
      set( KDSOURCEFLAGS "-Wl,-rpath,CMD(kdsource-config --show libdir) -Wl,CMD(kdsource-config --show libpath) -ICMD(kdsource-config --show includedir)" )
    endif()
  else()
    set( IDFGEN "" )
    set( NCRYSTALFLAGS "")
  ...
  if ( NOT NEXUSFLAGS )
    ...
    if ( MCCODE_BUILD_CONDA_PKG )
      set( NEXUSFLAGS "-DUSE_NEXUS -I\$\{CONDA_PREFIX\}/include/nexus -Wl,-rpath,$\{CONDA_PREFIX\}/lib -L\$\{CONDA_PREFIX\}/lib -lNeXus" )
    endif()
    if ( WINDOWS )
      if ( "${CMAKE_C_COMPILER_ID}" STREQUAL "MSVC" )
        set( NEXUSFLAGS " /DUSE_NEXUS /I\$\{CONDA_PREFIX\}/Library/include/nexus /link /LIBPATH:\$\{CONDA_PREFIX\}/Library/lib NeXus.lib" )
      else()
	set( NEXUSFLAGS "-DUSE_NEXUS -I\$\{CONDA_PREFIX\}/Library/include/nexus -Wl,-rpath,$\{CONDA_PREFIX\}/Library/lib -L\$\{CONDA_PREFIX\}/Library/lib -lNeXus" )
      endif()
    endif()
    if ( NEXUSLIB )
  ...
  if ( WINDOWS )
    if ("${CMAKE_C_COMPILER_ID}" STREQUAL "MSVC")
      if ( MCCODE_BUILD_CONDA_PKG )
	set( MCCODE_CFLAGS "${MCCODE_CFLAGS} /I\$\{CONDA_PREFIX\}/include /I\$\{CONDA_PREFIX\}/Library/include /link /LIBPATH:\$\{CONDA_PREFIX\}/Library/lib" )
      endif()
    else()
      set( MCCODE_CFLAGS "${MCCODE_CFLAGS} -I\$\{CONDA_PREFIX\}/include -I\$\{CONDA_PREFIX\}/Library/include -Wl,-rpath,$\{CONDA_PREFIX\}/Library/lib -L\$\{CONDA_PREFIX\}/Library/lib" )
    endif()
  else()
