...
\item[sources] Components that define the initial neutron state -- see
  the Sources chapter of the Component Manual.
...
\item[samples] Components modelling matter placed in the beam for
  ...
  the Samples chapter of the Component Manual.
...
\item[union] The Union framework (contributed by Mads Bertelsen): a set of
  ...
  the User Manual's chapter on instrument examples (Union\_demos) and the
  samples chapter.
...
category, is given in the User Manual's chapter on instrument examples.
Every
