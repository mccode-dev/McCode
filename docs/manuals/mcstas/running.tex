...
``Neutron site'' menu) and open the template/example \verb+Samples_vanadium+.
...
\item{or by setting the \verb+MCSTAS_FORMAT+ environment
variable.}
\end{itemize}
...
\begin{bash}
mcdisplay-webgl ./Samples_vanadium.out ROT=90
\end{bash}
