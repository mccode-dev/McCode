...
A rectangular time-of-flight monitor with logarithmic time binning. (The neutron intensity is NOT given logarithmically)
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{TOFlog\_monitor.comp}.
\end{itemize}
\IfFileExists{monitors/TOFlog_monitor_static.tex}{\input{monitors/TOFlog_monitor_static.tex}}{}