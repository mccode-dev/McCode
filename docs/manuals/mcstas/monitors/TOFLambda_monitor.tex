...
2D detector for intensity as a function of both time-of-flight and wavelength.
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{TOFLambda\_monitor.comp}.
\end{itemize}
\IfFileExists{monitors/TOFLambda_monitor_static.tex}{\input{monitors/TOFLambda_monitor_static.tex}}{}