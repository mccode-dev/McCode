...
Example: MeanPollambda\_monitor(xwidth=0.1, yheight=0.1, npol=11, my=1, filename="meanpollambdaMon.data")
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{MeanPolLambda\_monitor.comp}.
\end{itemize}
\IfFileExists{monitors/MeanPolLambda_monitor_static.tex}{\input{monitors/MeanPolLambda_monitor_static.tex}}{}