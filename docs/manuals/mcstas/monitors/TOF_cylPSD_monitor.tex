...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{TOF\_cylPSD\_monitor.comp}.
\end{itemize}
\IfFileExists{monitors/TOF_cylPSD_monitor_static.tex}{\input{monitors/TOF_cylPSD_monitor_static.tex}}{}