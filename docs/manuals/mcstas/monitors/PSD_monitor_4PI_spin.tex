...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{PSD\_monitor\_4PI\_spin.comp}.
\end{itemize}
\IfFileExists{monitors/PSD_monitor_4PI_spin_static.tex}{\input{monitors/PSD_monitor_4PI_spin_static.tex}}{}