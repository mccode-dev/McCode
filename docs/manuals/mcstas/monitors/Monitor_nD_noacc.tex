\section{The \texttt{Monitor\_nD\_noacc} McStas Component}
Release: McStas 1.6
Version: \$Revision\$
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{Monitor\_nD\_noacc.comp}.
\end{itemize}
\IfFileExists{monitors/Monitor_nD_noacc_static.tex}{\input{monitors/Monitor_nD_noacc_static.tex}}{}