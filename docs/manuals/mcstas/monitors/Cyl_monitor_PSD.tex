\section{The \texttt{Cyl\_monitor\_PSD} McStas Component}
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{Cyl\_monitor\_PSD.comp}.
\end{itemize}
\IfFileExists{monitors/Cyl_monitor_PSD_static.tex}{\input{monitors/Cyl_monitor_PSD_static.tex}}{}