...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{PSD\_monitor\_psf.comp}.
\end{itemize}
\IfFileExists{monitors/PSD_monitor_psf_static.tex}{\input{monitors/PSD_monitor_psf_static.tex}}{}