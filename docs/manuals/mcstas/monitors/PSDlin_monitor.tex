...
A 1-dimensional PSD measuring intensity along either the horizontal axis x (default) or the vertical axis y.

Example: PSDlin\_monitor(nbins=20, filename="Output.x", xmin=-0.1, xmax=0.1, ymin=-0.1, ymax=0.1)
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{PSDlin\_monitor.comp}.
\end{itemize}
\IfFileExists{monitors/PSDlin_monitor_static.tex}{\input{monitors/PSDlin_monitor_static.tex}}{}