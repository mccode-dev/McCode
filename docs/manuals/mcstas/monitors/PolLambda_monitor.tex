...
Example: Pollambda\_monitor(Lmin=1, Lmax=20, nL=20, xwidth=0.1, yheight=0.1, npol=11, mx=0, my=1, mz=0, filename="pollambdaMon.data")
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{PolLambda\_monitor.comp}.
\end{itemize}
\IfFileExists{monitors/PolLambda_monitor_static.tex}{\input{monitors/PolLambda_monitor_static.tex}}{}