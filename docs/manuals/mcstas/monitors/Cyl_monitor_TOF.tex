\section{The \texttt{Cyl\_monitor\_TOF} McStas Component}
...
nt & 1 & Number of t-bins & 100 \\
\textbf{tmin} & s & Minimum time measured &  \\
\textbf{tmax} & s & Maximum time measured &  \\
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{Cyl\_monitor\_TOF.comp}.
\end{itemize}
\IfFileExists{monitors/Cyl_monitor_TOF_static.tex}{\input{monitors/Cyl_monitor_TOF_static.tex}}{}