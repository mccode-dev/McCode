\subsection*{A neutron source with adaptive importance sampling}
...
The initial neutron weight is given by Eq. (\ref{e:flux-p0}) using
...
\subsubsection{Optimization disclaimer}
