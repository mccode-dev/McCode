\section{The \texttt{Guide\_gravity} McStas Component}
...
The reflectivity may be specified either using an analytical mode (see Component manual) or as a text file in free format, with 1st column as q[\AA{}-1] and 2nd column as the reflectivity R in [0-1]. For details on the geometry calculation see the description in the McStas component manual.
...
Example: Guide\_gravity(w1=0.1, h1=0.1, w2=0.1, h2=0.1, l=12,

\begin{verbatim}
R0=0.99, Qc=0.0219, alpha=6.07, m=1.0, W=0.003)
\end{verbatim}

\%VALIDATION May 2005: extensive internal test, all problems solved Validated by: nslit. Lieutenant
...
G & m/s$^{2}$ & Gravitation norm. 0 value disables G effects. & 0 \\
...
reflect & str & Reflectivity file name. Format \textless{}q(\AA{}-1) R(0-1)\textgreater{} & "NULL" \\
\bottomrule
\end{longtable}

\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{Guide\_gravity.comp}.
\end{itemize}
\IfFileExists{optics/Guide_gravity_static.tex}{\input{optics/Guide_gravity_static.tex}}{}