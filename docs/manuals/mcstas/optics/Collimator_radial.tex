...
When using zero as the number of channels (nchan), the collimator is continuous, whithout shadowing effect.
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{Collimator\_radial.comp}.
\end{itemize}
\IfFileExists{optics/Collimator_radial_static.tex}{\input{optics/Collimator_radial_static.tex}}{}