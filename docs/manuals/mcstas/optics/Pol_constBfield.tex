...
Example: Pol\_constBfield(xwidth=0.1, yheight=0.1, zdepth=0.2, fliplambda=5.0)
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{Pol\_constBfield.comp}.
\end{itemize}
\IfFileExists{optics/Pol_constBfield_static.tex}{\input{optics/Pol_constBfield_static.tex}}{}