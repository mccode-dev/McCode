...
wallwidth=0.0001, sGeomFileName="FC\_geom\_str.dat")

Fermi chopper with circular channels, 12000 rpm, optimized for 6 \AA{}, several pulses, highest accuracy (because of long wavelength neutrons used), rest as above
...
wallwidth=0.0001, sGeomFileName="FC\_geom\_circ.dat")
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{Vitess\_ChopperFermi.comp}.
  \item \htmladdnormallink{straight VITESS Fermi chopper}{http://www.hmi.de/projects/ess/vitess/DOC/chopper\_fermi\_str.html}
  \item \htmladdnormallink{curved VITESS Fermi chopper}{http://www.hmi.de/projects/ess/vitess/DOC/chopper\_fermi\_cur.html}
\end{itemize}
\IfFileExists{optics/Vitess_ChopperFermi_static.tex}{\input{optics/Vitess_ChopperFermi_static.tex}}{}