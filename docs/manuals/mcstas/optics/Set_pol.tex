...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{Set\_pol.comp}.
\end{itemize}
\IfFileExists{optics/Set_pol_static.tex}{\input{optics/Set_pol_static.tex}}{}