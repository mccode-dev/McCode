\section{The \texttt{Guide} McStas Component}
Neutron guide.
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{Guide.comp}.
\end{itemize}
\IfFileExists{optics/Guide_static.tex}{\input{optics/Guide_static.tex}}{}