...
When you rotate the component by A1 = asin(Q/2/Ki)*RAD2DEG, do not forget to rotate the following components by A2=2*A1 (for 1st order) !
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{Monochromator\_curved.comp}.
  \item \htmladdnormallink{Additional note}{http://mcstas.risoe.dk/pipermail/neutron-mc/1999q1/000133.html} from Peter Link.
  \item Obsolete Mosaic\_anisotropic by Kristian Nielsen
  \item Contributed Monochromator\_2foc by Peter Link
\end{itemize}
\IfFileExists{optics/Monochromator_curved_static.tex}{\input{optics/Monochromator_curved_static.tex}}{}