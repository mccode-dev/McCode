...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{Selector.comp}.
  \item See also Additional notes \htmladdnormallink{March 1999}{http://mcstas.risoe.dk/pipermail/neutron-mc/1999q1/000134.html} and \htmladdnormallink{Jan 2000}{http://mcstas.risoe.dk/pipermail/neutron-mc/1999q2/000136.html}.
\end{itemize}
\IfFileExists{optics/Selector_static.tex}{\input{optics/Selector_static.tex}}{}