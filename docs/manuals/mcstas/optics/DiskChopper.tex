...
Example: DiskChopper(radius=0.2, theta\_0=10, nu=41.7, nslit=3, delay=0, isfirst=1) First chopper DiskChopper(radius=0.2, theta\_0=10, nu=41.7, nslit=3, delay=0, isfirst=0)
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{DiskChopper.comp}.
\end{itemize}
\IfFileExists{optics/DiskChopper_static.tex}{\input{optics/DiskChopper_static.tex}}{}