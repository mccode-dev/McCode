...
Example: Monochromator\_flat(zmin=-0.1, zmax=0.1, ymin=-0.1, ymax=0.1, mosaich=30.0, mosaicv=30.0, r0=0.7, Q=1.8734)
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{Monochromator\_flat.comp}.
\end{itemize}
\IfFileExists{optics/Monochromator_flat_static.tex}{\input{optics/Monochromator_flat_static.tex}}{}