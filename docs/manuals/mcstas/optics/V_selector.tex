...
Example: V\_selector(xwidth=0.03, yheight=0.05, zdepth=0.30, radius=0.12, alpha=48.298, length=0.25, d=0.0004, nu=20000, nslit=72) These are values for the D11@ILL Dornier 'Dolores' Velocity Selector (NVS 023)
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{V\_selector.comp}.
\end{itemize}
\IfFileExists{optics/V_selector_static.tex}{\input{optics/V_selector_static.tex}}{}