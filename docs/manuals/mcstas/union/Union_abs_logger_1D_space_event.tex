\section{The \texttt{Union\_abs\_logger\_1D\_space\_event} McStas Component}
...
\textbf{n} & 1 & Number of bins along y &  \\
fake\_event & 1 & Number of fake events to add, circumvents issue with empty event lists with MPI & 0 \\
