\section{The \texttt{Union\_abs\_logger\_1D\_space\_tof\_to\_lambda} McStas Component}
...
\textbf{ref\_component} & 1 & Reference component instance index, sample position for distance calculation &  \\
...
relative\_max & 1 & Largest value of measured / true wavelength in histogram & 1.5 \\
relative\_bins & 1 & Number of bins on histogram axis with measured divided by true wavelength & 100 \\
