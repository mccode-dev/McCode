...
\def\@maketitle{\newpage \baselineskip 30dd \mbox{}
 ...
 \par\noindent\mbox{\includegraphics[height=1.5cm]{figures/risoe-logo.eps}\hspace{2mm}\includegraphics[height=1.5cm]{figures/DTU_logo.ps}} \par
 \vskip 1.5cm
 ...
 \frtnbf\noindent Risø DTU, Roskilde, Denmark \par
...
\title{Component~Manual~for~\rlap{the}\\ % Avoid overfull message.
 ...
 \MCS, Version \version\ }
\author{Peter Kjær Willendrup, Erik Knudsen, Kim Lefmann and\\Emmanuel Farhi}
\maketitle
\endgroup
