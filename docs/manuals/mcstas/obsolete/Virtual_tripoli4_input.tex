...
EXAMPLE: To create a 'source' from a Tripoli4 simulation event file for the ILL: COMPONENT source = Virtual\_tripoli4\_input( filename = "ILL\_SFH.dat", intensity=4.28e18, verbose = 1, autocenter="translate rotate rescale")
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{Virtual\_tripoli4\_input.comp}.
...
\end{itemize}
\IfFileExists{obsolete/Virtual_tripoli4_input_static.tex}{\input{obsolete/Virtual_tripoli4_input_static.tex}}{}