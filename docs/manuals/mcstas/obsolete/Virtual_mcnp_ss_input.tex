...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{Virtual\_mcnp\_ss\_input.comp}.
...
\end{itemize}
\IfFileExists{obsolete/Virtual_mcnp_ss_input_static.tex}{\input{obsolete/Virtual_mcnp_ss_input_static.tex}}{}