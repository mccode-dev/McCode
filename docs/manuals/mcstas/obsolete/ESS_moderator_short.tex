\section{The \texttt{ESS\_moderator\_short} McStas Component}
A parametrised pulsed source for modelling ESS short pulses.

\subsection*{Identification}
\begin{itemize}
  \item \textbf{Author:} KL, February 2001
...
Units of flux: n/cm\textasciicircum{}2/s/\AA{}/ster (McStas units are in general neutrons/second)

Example general parameters (general): size=0.12 Lmin=0.1 Lmax=10 dist=2 focus\_xw=0.06 yh=0.12 nu=50 branchframe=0.5
...
\midrule
\endhead
\textbf{size} & m & Edge of cube shaped source &  \\
...
branch1 & 1 & limit for switching between distribution 1 and 2. (has effect only for coupled water, tau1\textgreater{}0) & 0 \\
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{ESS\_moderator\_short.comp}.
\end{itemize}
\IfFileExists{obsolete/ESS_moderator_short_static.tex}{\input{obsolete/ESS_moderator_short_static.tex}}{}