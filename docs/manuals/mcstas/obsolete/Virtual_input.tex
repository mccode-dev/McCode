...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{Virtual\_input.comp}.
\end{itemize}
\IfFileExists{obsolete/Virtual_input_static.tex}{\input{obsolete/Virtual_input_static.tex}}{}