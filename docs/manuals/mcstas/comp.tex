...
For further details about polarization handling, you may refer to the Polarisation chapter, \ref{c:polarization}.
...
{\small
\begin{longtable}{|p{0.24\textwidth}|rrr|rr|p{0.24\textwidth}|}
...
\hline
\endfirsthead
\multicolumn{7}{l}{\small\itshape (Table \ref{t:liquids-data} continued from previous page)}\\
\hline
\textbf{MCSTAS/data} & $\sigma_{coh}$&$\sigma_{inc}$&$\sigma_{abs}$&$T_m$       & $c$    & Note \\
    File name     & [barns]     & [barns]    & [barns]    & [K]        & [m/s] & \\
\hline
...
\hline
\endlastfoot
Cs\_liq\_tot.sqw                      & 3.69      & 0.21     &29.0      &301.6     &\textbf{1090}  & liquid cesium. Bodensteiner et al, Phys. Rev. A, 45 (1992) 5709 and 46 (1992) 3574.\\
...
He4\_liq\_coh.sqw                     & 1.34      & 0        &0.00747   &2         &\textbf{240}   & liquid helium. Measured (constant width). R.J. Donnelly et al., J. Low Temp. Phys., 44 (1981) 471\\
...
regression suite (see the User Manual's section on self-testing the
installation), which
