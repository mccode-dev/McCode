...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{SANSEllipticCylinders.comp}.
\end{itemize}
\IfFileExists{contrib/SANSEllipticCylinders_static.tex}{\input{contrib/SANSEllipticCylinders_static.tex}}{}