...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{PSD\_Detector.comp}.
  \item The test/example instrument \htmladdnormallink{Test\_PSD\_Detector.instr}{../examples/Test\_PSD\_Detector.instr}.
\end{itemize}
\IfFileExists{contrib/PSD_Detector_static.tex}{\input{contrib/PSD_Detector_static.tex}}{}