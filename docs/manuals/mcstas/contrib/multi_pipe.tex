...
Example: multi\_pipe(xmin=-0.01, xmax=0.01, ymin=-0.01, ymax=0.01)
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{multi\_pipe.comp}.
\end{itemize}
\IfFileExists{contrib/multi_pipe_static.tex}{\input{contrib/multi_pipe_static.tex}}{}