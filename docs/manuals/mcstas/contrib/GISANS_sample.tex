...
the total thickness of the sandwich is zsapph+zsamp+zsilicon the thicknesses zsampsurf and zsiliconsurf are parts of the total sample/silicon thicknesses
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{GISANS\_sample.comp}.
\end{itemize}
\IfFileExists{contrib/GISANS_sample_static.tex}{\input{contrib/GISANS_sample_static.tex}}{}