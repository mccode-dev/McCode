...
Example: spot\_sample(radius\_o=0.01, h=0.05, pack = 1, xwidth=0, yheight=0, zthick=0, Eideal=100.0,w=50.0,two\_theta=25.0,n\_spots=4)
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{Spot\_sample.comp}.
\end{itemize}
\IfFileExists{contrib/Spot_sample_static.tex}{\input{contrib/Spot_sample_static.tex}}{}