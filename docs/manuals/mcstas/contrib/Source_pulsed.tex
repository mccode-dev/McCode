...
Parameters for some sources: HBS thermal source: xwidth=0.04, yheight=0.04, T1=325.0, I1=0.68e+12/freq, tau1=0.000125, n\_mod=10, I\_um=2.47e+10/freq, chi\_um=2.5, t\_pulse=0.016/freq, freq=96.0 or 24.0
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{Source\_pulsed.comp}.
\end{itemize}
\IfFileExists{contrib/Source_pulsed_static.tex}{\input{contrib/Source_pulsed_static.tex}}{}