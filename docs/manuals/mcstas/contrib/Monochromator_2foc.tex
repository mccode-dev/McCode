...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{Monochromator\_2foc.comp}.
  \item \htmladdnormallink{Additional note}{http://mailman.risoe.dk/pipermail/neutron-mc/1999q1/000133.html} from \htmladdnormallink{Peter Link}{mailto:plink@physik.tu-muenchen.de}.
\end{itemize}
\IfFileExists{contrib/Monochromator_2foc_static.tex}{\input{contrib/Monochromator_2foc_static.tex}}{}