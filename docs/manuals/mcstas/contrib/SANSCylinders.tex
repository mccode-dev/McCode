\section{The \texttt{SANSCylinders} McStas Component}
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{SANSCylinders.comp}.
\end{itemize}
\IfFileExists{contrib/SANSCylinders_static.tex}{\input{contrib/SANSCylinders_static.tex}}{}