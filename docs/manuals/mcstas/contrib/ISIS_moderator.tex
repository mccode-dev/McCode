...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{ISIS\_moderator.comp}.
  \item Further \htmladdnormallink{information}{http://www.isis.rl.ac.uk/Computing/Software/MC/index.htm} should be
  \item downloaded from the ISIS MC website.
  \item *******************************************************************************/
\end{itemize}
\IfFileExists{contrib/ISIS_moderator_static.tex}{\input{contrib/ISIS_moderator_static.tex}}{}