...
R = focus for a parabolic lens with focal of the parabola and n = sqrt(1-(lambda*lambda*rho*bc/PI)) with bc = sqrt(fabs(sigma\_coh)*100/4/PI)*1e-5 rho = density*6.02214179*1e23*1e-24/weight
...
density & g/cm$^{3}$ & density of the material for the lens & 3.148 \\
...
RMS & \AA{} & root mean square roughness of the surface & 0 \\
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{Lens.comp}.
...
\end{itemize}
\IfFileExists{contrib/Lens_static.tex}{\input{contrib/Lens_static.tex}}{}