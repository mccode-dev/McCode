\section{The \texttt{PSD\_spinDmon} McStas Component}
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{PSD\_spinDmon.comp}.
\end{itemize}
\IfFileExists{contrib/PSD_spinDmon_static.tex}{\input{contrib/PSD_spinDmon_static.tex}}{}