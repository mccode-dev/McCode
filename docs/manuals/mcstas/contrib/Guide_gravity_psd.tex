...
Example: Guide\_gravity\_psd(w1=0.1, h1=0.1, w2=0.1, h2=0.1, l=12,

\begin{verbatim}
R0=0.99, Qc=0.0219, alpha=6.07, m=1.0, W=0.003)
\end{verbatim}

\%VALIDATION May 2005: extensive internal test, all problems solved Validated by: K. Lieutenant
...
reflect & str & Reflectivity file name. Format q(\AA{}-1) R(0-1) & "NULL" \\
\bottomrule
\end{longtable}

\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{Guide\_gravity\_psd.comp}.
\end{itemize}
\IfFileExists{contrib/Guide_gravity_psd_static.tex}{\input{contrib/Guide_gravity_psd_static.tex}}{}