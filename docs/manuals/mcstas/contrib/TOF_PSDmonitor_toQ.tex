...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{TOF\_PSDmonitor\_toQ.comp}.
\end{itemize}
\IfFileExists{contrib/TOF_PSDmonitor_toQ_static.tex}{\input{contrib/TOF_PSDmonitor_toQ_static.tex}}{}