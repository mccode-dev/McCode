\section{The \texttt{SANSNanodiscsWithTagsFast} McStas Component}
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{SANSNanodiscsWithTagsFast.comp}.
\end{itemize}
\IfFileExists{contrib/SANSNanodiscsWithTagsFast_static.tex}{\input{contrib/SANSNanodiscsWithTagsFast_static.tex}}{}