...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{TOF2Q\_cyl\_monitor.comp}.
\end{itemize}
\IfFileExists{contrib/TOF2Q_cyl_monitor_static.tex}{\input{contrib/TOF2Q_cyl_monitor_static.tex}}{}