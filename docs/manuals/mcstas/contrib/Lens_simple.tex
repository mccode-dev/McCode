...
For lens arrays one still can simulate several of these simplified lenses instead of an exact treatment (because 5cm\textless{}\textless{}1m). The author believes that this medium detailed treatment meets usually the desired accuracy.

Example: Lens\_simple(rho=5.16e10,Rc=0.0254,Nl=7,xmin=-0.01,xmax=0.01,ymin=-0.01,ymax=0.01) Lens\_simple(rho=5.16e10,Rc=0.0254,Nl=7,radius=0.01) Lens\_simple(rho=5.16e10,Rc=0.0254,Nl=7,radius=0.035,SigmaAL=0.141, d0=0.002) \textasciicircum{}\textasciicircum{}\textasciicircum{}\textasciicircum{}\textasciicircum{}\textasciicircum{}\textasciicircum{}\textasciicircum{}\textasciicircum{}\textasciicircum{}\textasciicircum{} last example includes absorption of MgF2-lens.
...
\end{itemize}
\IfFileExists{contrib/Lens_simple_static.tex}{\input{contrib/Lens_simple_static.tex}}{}