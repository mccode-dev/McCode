...
Example: Multilayer\_Sample(xmin=-0.1, xmax=0.1,zmin=-0.1, zmax=0.1, nlayer=1,sldPar=\{0.0,2.0e-6,0.0e-6\},dPar=\{20.0\}, sigmaPar=\{5.0,5.0\})
...
mu\_inc & m$^{-1}$ & Incoherent scattering length & 5.62 \\
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{Multilayer\_Sample.comp}.
\end{itemize}
\IfFileExists{contrib/Multilayer_Sample_static.tex}{\input{contrib/Multilayer_Sample_static.tex}}{}