...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{PerfectCrystal.comp}.
\end{itemize}
\IfFileExists{contrib/PerfectCrystal_static.tex}{\input{contrib/PerfectCrystal_static.tex}}{}