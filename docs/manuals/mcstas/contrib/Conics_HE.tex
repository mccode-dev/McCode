\section{The \texttt{Conics\_HE} McStas Component}
Release: McStas 2.7
Date: September 2021
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{Conics\_HE.comp}.
\end{itemize}
\IfFileExists{contrib/Conics_HE_static.tex}{\input{contrib/Conics_HE_static.tex}}{}