\section{The \texttt{SANSNanodiscs} McStas Component}
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{SANSNanodiscs.comp}.
\end{itemize}
\IfFileExists{contrib/SANSNanodiscs_static.tex}{\input{contrib/SANSNanodiscs_static.tex}}{}