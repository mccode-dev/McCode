...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{SANSNanodiscsFast.comp}.
\end{itemize}
\IfFileExists{contrib/SANSNanodiscsFast_static.tex}{\input{contrib/SANSNanodiscsFast_static.tex}}{}