...
Example: E\_4PI(filename="e4pi.dat",ne=200,Emin=0,Emax=E*2)
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{E\_4PI.comp}.
...
\end{itemize}
\IfFileExists{contrib/E_4PI_static.tex}{\input{contrib/E_4PI_static.tex}}{}