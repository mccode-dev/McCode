\section{The \texttt{Conics\_PP} McStas Component}
Release: McStas 2.7
Date: September 2021
...
focal\_length\_u & m & Focal length of upstream mirror. & 10.070 \\
focal\_length\_d & m & Focal length of downstream mirror. & 10.070 \\
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{Conics\_PP.comp}.
\end{itemize}
\IfFileExists{contrib/Conics_PP_static.tex}{\input{contrib/Conics_PP_static.tex}}{}