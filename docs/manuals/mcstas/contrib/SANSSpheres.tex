\section{The \texttt{SANSSpheres} McStas Component}
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{SANSSpheres.comp}.
\end{itemize}
\IfFileExists{contrib/SANSSpheres_static.tex}{\input{contrib/SANSSpheres_static.tex}}{}