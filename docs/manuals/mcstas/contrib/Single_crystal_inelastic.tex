...
You may generate such files using \htmladdnormallink{iFit}{http://ifit.mccode.org} such as:
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{Single\_crystal\_inelastic.comp}.
\end{itemize}
\IfFileExists{contrib/Single_crystal_inelastic_static.tex}{\input{contrib/Single_crystal_inelastic_static.tex}}{}