...
Example: FermiChopper\_ILL(phase=-50.0, radius=0.04, nu=100,
...
\%VALIDATION Apr 2005: extensive external test, most problems solved (cf. 'Bugs') Validated by: K. Lieutenant
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{FermiChopper\_ILL.comp}.
\end{itemize}
\IfFileExists{contrib/FermiChopper_ILL_static.tex}{\input{contrib/FermiChopper_ILL_static.tex}}{}