...
Example: Pol\_triafield(xwidth=0.1, yheight=0.1, zdepth=0.2, B=1e-3, Bguide=0.0)
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{Pol\_triafield.comp}.
\end{itemize}
\IfFileExists{contrib/Pol_triafield_static.tex}{\input{contrib/Pol_triafield_static.tex}}{}