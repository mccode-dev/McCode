...
\midrule
\endhead
reflect & str & Reflectivity file name. Format [q(\AA{}\textasciicircum{}-1) R(0-1)] & 0 \\
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{Guide\_m.comp}.
\end{itemize}
\IfFileExists{contrib/Guide_m_static.tex}{\input{contrib/Guide_m_static.tex}}{}