\section{The \texttt{Guide\_four\_side} McStas Component}
Guide with four side walls

\subsection*{Identification}
\begin{itemize}
  \item \textbf{Author:} Tobias Panzner
  \item \textbf{Origin:} PSI
  \item \textbf{Date:} 07/08/2010
\end{itemize}
...
Every single wall can have a elliptic, parabolic or straight shape. All four sides of the guide are independent from each other. In the elliptic case the side wall shape follows the equation x\textasciicircum{}2/b\textasciicircum{}2+(z+z0)\textasciicircum{}2/a\textasciicircum{}2=1 (the center of the ellipse is located at (0,-z0)). In the parabolic case the side wall shape follows the equation z=b-ax\textasciicircum{}2;mc In the straight case the side wall shape follows the equation z=l/(w2-w1)*x-w1.
...
The reflectivity properties can be given by an input file (Format [q(\AA{}-1) R(0-1)]) or by parameters (Qc, alpha, m, W).
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{Guide\_four\_side.comp}.
\end{itemize}
\IfFileExists{contrib/Guide_four_side_static.tex}{\input{contrib/Guide_four_side_static.tex}}{}