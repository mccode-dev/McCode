...
Example: PSD\_Pol\_monitor(xmin=-0.1, xmax=0.1, ymin=-0.1, ymax=0.1, nx=90, ny=90, my=1, filename="Output.psd")
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{PSD\_Pol\_monitor.comp}.
\end{itemize}
\IfFileExists{contrib/PSD_Pol_monitor_static.tex}{\input{contrib/PSD_Pol_monitor_static.tex}}{}