...
Example: Guide\_honeycomb(w1=0.1, w2=0.1, l=12,
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{Guide\_honeycomb.comp}.
\end{itemize}
\IfFileExists{contrib/Guide_honeycomb_static.tex}{\input{contrib/Guide_honeycomb_static.tex}}{}