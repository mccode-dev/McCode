...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{Sans\_liposomes\_new.comp}.
  \item The test/example instrument \htmladdnormallink{SANS.instr}{../examples/SANS.instr}.
\end{itemize}
\IfFileExists{contrib/Sans_liposomes_new_static.tex}{\input{contrib/Sans_liposomes_new_static.tex}}{}