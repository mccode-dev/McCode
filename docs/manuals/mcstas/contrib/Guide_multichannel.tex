...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{Guide\_multichannel.comp}.
\end{itemize}
\IfFileExists{contrib/Guide_multichannel_static.tex}{\input{contrib/Guide_multichannel_static.tex}}{}