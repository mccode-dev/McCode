...
\par\noindent\mbox{\includegraphics[height=2cm]{figures/risoe-logo.eps} %
\hspace{2mm}\includegraphics[height=3cm]{figures/DTU_logo.png}} %
\par\vskip 1.5cm
 {\twfvbf \noindent \@title \par} \vskip 20dd \baselineskip 16dd
 {\frtnbf\noindent\@author \par} 
 \vskip 1.0cm
   \begin{flushright}
     \includegraphics[width=0.95\textwidth]{figures/frontpage.pdf}
   \end{flushright}
