\section{The \texttt{Shape\_simple} McStas Component}
...
An inactive geometrical shape, for drawing purposes only. It does not propagate neutron, nor interact. \textbf{Shape:} Geometric shape may be a cylinder, a sphere, a box or any other shape
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{Shape\_simple.comp}.
...
\end{itemize}
\IfFileExists{misc/Shape_simple_static.tex}{\input{misc/Shape_simple_static.tex}}{}