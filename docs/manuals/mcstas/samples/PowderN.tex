\section{The \texttt{PowderN} McStas Component}
...
\begin{itemize}
  ...
  \item \textbf{Origin:} McStas release
...
\#column\_strain \textless{}index of the strain line shift Delta/d [ppm]\textgreater{}
...
sigma\_abs & barns & Absorption cross section per unit cell at 2200 m/s. Use a negative value to inactivate it. & 0 \\
sigma\_inc & barns & Incoherent cross section per unit cell. Use a negative value to inactivate it. & 0 \\
delta\_d\_d & 0/1 & Global relative delta\_d\_d/d broadening when the 'w' column is not available. Use 0 if ideal. & 0 \\
p\_inc & 1 & Fraction of incoherently scattered neutron rays. & 0.1 \\
p\_transmit & 1 & Fraction of transmitted (only attenuated) neutron rays. & 0.1 \\
...
p\_interact & 1 & Fraction of events interacting coherently with sample. & 0.8 \\
...
\begin{itemize}
  ...
  \item "Validation of a realistic powder sample using data from DMC at PSI" Willendrup P, Filges U, Keller L, Farhi E, Lefmann K, Physica B-Cond Matt 385 (2006) 1032.
  \item See also: Powder1, Single\_crystal
