...
sigma\_abs & m$^{-1}$ & Absorption cross section density at 2200 m/s & 0.05 \\
...
\subsection*{Links}
\begin{itemize}
  \item Component source code found in file \texttt{Sans\_spheres.comp}.
  \item The test/example instrument \htmladdnormallink{SANS.instr}{../examples/SANS.instr}.
\end{itemize}
\IfFileExists{samples/Sans_spheres_static.tex}{\input{samples/Sans_spheres_static.tex}}{}