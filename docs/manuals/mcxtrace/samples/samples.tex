...
Next type is Bragg scattering from single crystals. Two types of single crystal
components exist in \MCX\ at present: \textbf{Bragg\_crystal} (in the optics
category) and \textbf{Single\_crystal}.
\textbf{Bragg\_crystal} is in fact most often used as a monchromator crystal. It models a 
...
the probability transformation rule (\ref{e:probrule}).
...
According to (\ref{e:probrule}), the x-ray weight factor
