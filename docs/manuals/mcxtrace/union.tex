...
See the User Manual's chapter on instrument examples
(section~\ref{s:instrument}) for how to browse these. A number of the
individual component headers, documented in the Component Manual's Union
chapter, contain further short usage examples.
